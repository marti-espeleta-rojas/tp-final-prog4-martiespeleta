...
|--------|----------|-------------|
| GET | `/api/rutinas` | Listar todas las rutinas con ejercicios |
| GET | `/api/rutinas/{id}` | Obtener detalle de una rutina |
| GET | `/api/rutinas/buscar/nombre?nombre={texto}` | Buscar rutinas por nombre |
| POST | `/api/rutinas` | Crear nueva rutina con ejercicios |
| PUT | `/api/rutinas/{id}` | Actualizar rutina y sus ejercicios |
| DELETE | `/api/rutinas/{id}` | Eliminar rutina y sus ejercicios |
...
2. Ingresa nombre: "Test Rutina"
3. Ingresa descripción: "Prueba"
4. Haz clic en "+ Agregar Ejercicio"
5. Completa: Press de banca, Lunes, 4x8, 100kg
6. Haz clic en "Crear Rutina"
7. Debe aparecer en el listado

### Test Manual: Editar Rutina

1. Haz clic en "Editar" de una rutina
2. Haz clic en "+ Agregar Ejercicio"
3. Completa un nuevo ejercicio
4. Haz clic en "Agregar Ejercicio"
5. Debe aparecer inmediatamente
6. Haz clic en "Finalizar Edición"
7. Debe guardarse en BD
...
1. Revisa el README específico (backend o frontend)
